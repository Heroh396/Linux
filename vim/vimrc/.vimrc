...
" Install pathgen for vim-vhdl
"execute pathogen#infect() "(avalable)
set statusline+=%#warningmsg#
...
call vundle#begin()
	...
	Plugin 'tabular'
	Plugin 'syntastic' "check compile"
	...
	"Plugin 'Conque-GDB' "debug with gdb, cannot test
	"Plugin 'DoxygenToolkit.vim'
	"Plugin 'delimitMate' "tu dong dong, mo ngoac
	"Plugin 'matchit'
	"Plugin 'systemverilog.vim'
	"Plugin 'tagbar'	"create a tag bar"
	"Plugin 'snipmate'	"create snipset to shortkey"
	"Plugin 'tlib_vim'
	"Plugin 'ultisnips'  "like snipset"
	"Plugin 'vim-addon-mw-utils'
	"Plugin 'vim-airline'	"style for vim"
	"Plugin 'vim-gitgutter'	"compare with history file"
	"Plugin 'vim-snippets'
	"Plugin 'vim-surround'
